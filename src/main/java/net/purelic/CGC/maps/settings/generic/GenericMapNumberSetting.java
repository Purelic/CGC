...
public class GenericMapNumberSetting extends MapNumberSetting {

    public GenericMapNumberSetting(String baseCommand, String name, String description, String suffix, int min, int max, int increment, boolean plural, int defaultValue) {
        super(baseCommand, name, description, suffix, min, max, increment, plural, defaultValue);
    }
