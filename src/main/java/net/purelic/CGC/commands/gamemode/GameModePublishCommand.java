...
public class GameModePublishCommand implements CustomCommand {
    ...
    public Command.Builder<CommandSender> getCommandBuilder(BukkitCommandManager<CommandSender> mgr) {
        return mgr.commandBuilder("gamemode", "gm")
            ...
            .handler(c -> {
                ...
                gameMode.setPublic(true);
                DatabaseUtils.updateGameMode(gameMode.getId(), gameMode.toYaml());
                CommandUtils.sendSuccessMessage(player, "Game mode successfully published!");
