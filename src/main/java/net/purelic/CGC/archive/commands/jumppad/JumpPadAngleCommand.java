...
//
//public class JumpPadAngleCommand implements CustomCommand {
//
//    @Override
...
//                .argument(IntegerArgument.<CommandSender>newBuilder("angle").withMin(15).withMax(90).asRequired())
//                .handler(c -> {
