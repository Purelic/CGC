...
//
//public class GeneralNightVisionCommand implements CustomCommand {
//
//    @Override
...
//                .argument(BooleanArgument.of("enable"))
//                .handler(c -> {
//                    Player player = (Player) c.getSender();
//                    boolean allow = c.get("enable");
...
//                        yaml.getGeneralSettings().setNightVision(allow);
//                        yaml.updateYaml();
