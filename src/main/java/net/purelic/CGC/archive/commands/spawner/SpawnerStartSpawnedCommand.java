...
//
//public class SpawnerStartSpawnedCommand implements CustomCommand {
//
//    @Override
//    public Command.Builder<CommandSender> getCommandBuilder(BukkitCommandManager<CommandSender> mgr) {
//        return mgr.commandBuilder("spawner")
//                .senderType(Player.class)
//                .literal("start_spawned")
//                .argument(IntegerArgument.of("id"))
//                .argument(BooleanArgument.of("start spawned"))
//                .handler(c -> {
...
//                        spawner.setStartSpawned(startSpawned);
//                        yaml.updateYaml();
//
