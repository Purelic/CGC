...
//
//public class SpawnRemoveCommand implements CustomCommand {
//
//    @Override
...
//                        }
//
//                        yaml.removeSpawn(team, id - 1);
//                        CommandUtils.sendSuccessMessage(player, "You successfully removed the " + YamlUtils.formatEnumString(team.name()) + " spawn!");
//                    }
//                });
//    }
//
