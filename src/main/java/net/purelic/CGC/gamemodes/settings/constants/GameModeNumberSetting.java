...
public enum GameModeNumberSetting implements GameModeSetting {
    ...
    PLAYER_HELMET_PROT(GameModeSettingType.PLAYER_HELMET, "Protection", "Protection enchantment level", 1, 0, 4, 1, "", false),
    PLAYER_HELMET_PROJ_PROT(GameModeSettingType.PLAYER_HELMET, "Proj. Protection", "Projectile Protection enchantment level", 0, 0, 4, 1, "", false),
    PLAYER_CHESTPLATE_PROT(GameModeSettingType.PLAYER_CHESTPLATE, "Protection", "Protection enchantment level", 2, 0, 4, 1, "", false),
    PLAYER_CHESTPLATE_PROJ_PROT(GameModeSettingType.PLAYER_CHESTPLATE, "Proj. Protection", "Projectile Protection enchantment level", 2, 0, 4, 1, "", false),
    PLAYER_LEGGINGS_PROT(GameModeSettingType.PLAYER_LEGGINGS, "Protection", "Protection enchantment level", 0, 0, 4, 1, "", false),
    PLAYER_LEGGINGS_PROJ_PROT(GameModeSettingType.PLAYER_LEGGINGS, "Proj. Protection", "Projectile Protection enchantment level", 2, 0, 4, 1, "", false),
    PLAYER_BOOTS_PROT(GameModeSettingType.PLAYER_BOOTS, "Protection", "Protection enchantment level", 0, 0, 4, 1, "", false),
    PLAYER_BOOTS_PROJ_PROT(GameModeSettingType.PLAYER_BOOTS, "Proj. Protection", "Projectile Protection enchantment level", 0, 0, 4, 1, "", false),
    PLAYER_BOOTS_FF(GameModeSettingType.PLAYER_BOOTS, "Feather Falling", "Feather Falling enchantment level", 1, 0, 4, 1, "", false),
    PLAYER_BOOTS_DEPTH_STRIDER(GameModeSettingType.PLAYER_BOOTS, "Depth Strider", "Depth Strider enchantment level", 1, 0, 3, 1, "", false),
